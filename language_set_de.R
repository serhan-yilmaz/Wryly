...
language_set_de <- function(){
  ...
  ls$AnimationSpeedLabel = "Animationen Geschwindigkeit:"
  ...
  ls$HowtoplayAim = "Ein Wort mit 5 Buchstaben ist versteckt, das Ziel ist es, es zu finden!"
  ...
  ls$GrayColors = "Graue Farben"
  ls$HowtoplayGrayDesc = " anzeigen, dass das versteckte Wort den entsprechenden Buchstaben nicht enthält."
  ls$OrangeColors = "Orange Farben"
  ls$ColorblindOrangeColors = "Gelbe Farben"
  ls$HowtoplayOrangeDesc = " anzeigen, dass das versteckte Wort den entsprechenden Buchstaben enthält, aber die Positionierung des Buchstabens ist falsch."
  ls$GreenColors = "Grüne Farben"
  ls$ColorblindGreenColors = "Blaue Farben"
  ls$HowtoplayGreenDesc = "anzeigen, dass das versteckte Wort den entsprechenden Buchstaben enthält, und die Positionierung des Buchstabens ist richtig!"
  
  ls$HowtoplayBeforeBrown = "Zusätzlich, "
  ls$BrownColors = "Braune Farben"
  ls$HowtoplayAfterBrown = " im Hardcore-Modus zeigen an, dass die Buchstaben keine Anhaltspunkte liefert"
